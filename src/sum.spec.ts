...
test('array containing objects', () => {
    ...
    expect(objects).toStrictEqual(expect.arrayContaining([{ name: "mike", age: 33 }]))
    expect(objects).not.toEqual(expect.arrayContaining([{ name: "mike", age: 33 }, { name: "bob", age: 32 }]))
})
